package com.learning.atoz.storycreation.view.components.clipart
{
	...
	*/
	public class SwfThumbComponent extends Sprite
	{
		...
		//-----------------------------------------------------		
		public function SwfThumbComponent()
		{
		...
		{			
			...
			if(caloadclip!=null)
			{
				caloadclip.lblLoading.text="File not found ";				
			}
		...
		function onSWFComplete(event:Event):void
		{
			...
			//trace("onSWFComplete=>x="+swfContent.x+",y="+swfContent.y+",w="+swfContent.width+"h="+swfContent.height);
			this.removeChild(caloadclip);
			...
			if (resizeType == "FIXED")
			{
				...
				{					
					swfContent.scaleX=0.75;
					swfContent.scaleY=0.75;
				}
				...
				if(found==true)
				{
					swfContent.x -=  (swfContent.width*2.9);
					swfContent.y -=  (swfContent.height*2.9);
				}
				else
				{
					swfContent.x -=  swfContent.width / 2;
			...
			//trace("onSWFComplete2=>x="+swfContent.x+",y="+swfContent.y+",w="+swfContent.width+"h="+swfContent.height);
						
			this.graphics.beginFill(0xEEEEEE,0.0);
			...
			//trace("onSWFComplete3=>x="+swfContent.x+",y="+swfContent.y+",w="+swfContent.width+"h="+swfContent.height);
		...
		{
			TweenLite.to(this, 0.3, { scaleX:1.30, scaleY:1.30 } );
		}
		//-----------------------------------------------------		
