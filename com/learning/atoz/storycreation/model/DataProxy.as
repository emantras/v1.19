package com.learning.atoz.storycreation.model
{
	...
	*/
	/*
	DataProxy is used to maintain each page information 
	*/
	...
	public class DataProxy extends Proxy implements IProxy
	{
		...
		private var usertype:String="Fluent";
		...
		//-----------------------------------------------------
		public function set UserType(_usertype:String):void
		{
			usertype=_usertype;
		}
		//-----------------------------------------------------
		...
		{	
			...
			for(var r:int=0;r<_data.length;r++)
			{
				...
				if(_data[r].Pageno==_pageno)
				{
					...
					if(_data[r].Bgurl.length>0 ||  _data[r].dataList.length>0 || _data[r].callouttextList.length>0)
					{
		...
		//-----------------------------------------------------
		//to retrieve page title of the front cover
		//-----------------------------------------------------
		...
		public function getBookData():String
		{
			...
			bookdata+="<UserType>"+UserType+"</UserType>";
			for(var r:int=0;r<_data.length;r++)
			{				
