package com.learning.atoz.transform
{
	...
	public class TransformTool extends Sprite {
		...
		public var targetBounds:Rectangle = new Rectangle();
		...
		public function set target(d:DisplayObject):void {
			...
			//This script is to drag on first click itself
			_currentControl = _moveControl;
			setupInteraction();			
			_currentControl.dispatchEvent(new MouseEvent(MouseEvent.MOUSE_DOWN));
		...
		public function skewXInteraction():void {
			trace("_registration.x:"+_registration.x+",y:"+_registration.y);
			currentMode="SKEWX";
...
import com.learning.atoz.transform.TransformToolControl;
import com.learning.atoz.transform.TransformToolCursor;
