package com.learning.atoz.storycreation.model
{
	...
	*/
	public class LoadBookViewerProxy extends Proxy implements IProxy
	{		
		public static const NAME:String = "LoadBookViewerProxy";
		...
		//-----------------------------------------------------
		public function LoadBookViewerProxy() 
        {
            super ( NAME,this );
		...
		{				
			...
			try
			{
				...
				trace("LoadBookViewer1=>"+loadurl+"/"+bookid);
		...
		public function onLoadComplete( e:Event ):void
		{
			...
			_data=rawData;
			trace("loadBookViewProxy2=>"+rawData);
			facade.sendNotification(ApplicationConstants.VIEW_BOOK,rawData);
