package com.learning.atoz.storycreation.model
{
	...
	*/
	public class LoadWritingPlannerProxy extends Proxy implements IProxy
	{		
		public static const NAME:String = "LoadWritingPlannerProxy";
		private var request:URLRequest;
		private var myLoader:URLLoader;
		private var loadurl:String='http://emantras.raz-kids.com/main/CreativeWritingSaveLoad/action/loadWritingPlanner/id';
		private var _data:String;
		
		//-----------------------------------------------------
		public function LoadWritingPlannerProxy() 
        {
            super ( NAME,this );
		...
		//-----------------------------------------------------
		public function LoadWritingPlanner(id:int):void
		{	
			facade.sendNotification(ApplicationConstants.SHOW_WAIT_POPUP,"Loading WritingPlanner.....");
			try
			{
				if(id>0)
				{	
					request = new URLRequest(loadurl+"/"+id);
					trace("LoadWritingPlanner=>"+request.url);
		...
		public function onLoadComplete( e:Event ):void
		{
			...
			trace("LoadWritingPlannerProxy=>LoadWritingPlanner=>"+rawData);
			facade.sendNotification(ApplicationConstants.LOADED_WRITING_PLANNER_DATA,rawData);
		}
		//-----------------------------------------------------
